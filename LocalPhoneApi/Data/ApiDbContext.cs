...
namespace LocalPhoneApi.Data
{
    public class ApiDbContext : IdentityDbContext<UserModel>
    {
        ...
        public virtual DbSet<SmsRelatedInformationModel> SmsRelatedInformation { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PaymentModel>(entity =>
            {
                ...
                entity.Property(e => e.NameOnCard).HasColumnName("NameOnCard")
                    .HasMaxLength(250);
            ...
            modelBuilder.Entity<SmsRelatedInformationModel>(entity =>
            {
                ...
                entity.HasOne(e => e.Customer)
                    ...
                    .HasConstraintName("FK_SmsCustomer");
            });
